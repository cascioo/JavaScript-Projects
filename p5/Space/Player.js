Player = function(pos){
  ...
  this.update = function(){
    ...
    if(this.ammo > 0){
      this.ammo -= 1;
      if(max > 0 && max < 10) {
        this.bullets[this.bullets.length] = new Bullet(this.pos.copy(), 20)
      } else if( max > 9){
        this.bullets[this.bullets.length] = new Bullet(this.pos.copy(), 0)
        this.bullets[this.bullets.length] = new Bullet(this.pos.copy(), 40)
      }
    }
